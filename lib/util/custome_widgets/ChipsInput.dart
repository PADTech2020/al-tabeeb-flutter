...
class ChipsInputState<T> extends State<ChipsInput<T>> implements TextInputClient {
  ...
  void initState() {
    super.initState();
    _focusNode = FocusNode(debugLabel: '################ChipsInput FocusNode');
    _focusNode.addListener(_onFocusChanged);
    if (widget.initChips != null) {
      _chips = widget.initChips.toSet();
      ...
      children: <Widget>[
        ...
        if (_suggestions != null)
          Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: _suggestions.map((e) => widget.suggestionBuilder(context, this, e)).toList(),
              ),
            ),
          ),
        // Expanded(
